...
const title = computed(() => `Меню ресторана ${siteInfo.value?.name ?? "Sir Rabbit"}`);
const description = computed(() => 
    `Ознакомьтесь с актуальным меню ресторана ${siteInfo.value?.name ?? "Sir Rabbit"}. Изысканные блюда, авторские коктейли и специальные предложения.`
);
